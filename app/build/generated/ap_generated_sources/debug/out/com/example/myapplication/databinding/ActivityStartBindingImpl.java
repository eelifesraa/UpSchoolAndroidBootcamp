...
public class ActivityStartBindingImpl extends ActivityStartBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.letsStart, 2);
        sViewsWithIds.put(R.id.editTextTextEmailAddress, 3);
        sViewsWithIds.put(R.id.editTextTextPassword, 4);
        sViewsWithIds.put(R.id.textView2, 5);
        sViewsWithIds.put(R.id.SigninBtn, 6);
